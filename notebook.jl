...
# ╔═╡ 3816d05b-b217-4d09-b491-9d0951cdeffa
md"""
# Day 1
"""
...
data3 = split(strip(read("input3.txt", String)), r"\n")
...
matches = data3 .|> half .|> match

# ╔═╡ 0a16e016-7b33-11ed-2ff3-e9ff89d46115
data4 = split(strip(read("input4.txt", String)), r"\n")
...
ans6a = findStart(data)

# ╔═╡ a66ee016-ae9c-4885-913a-beb264b09b53
ans6b = findStart(data, 14)
